 ...
 * @author 08111349114
 */
public class Eg_JDlgVendedor extends javax.swing.JDialog {
    ...
    public Eg_JDlgVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    Util.habilitar(true, jjm_jBtnIncluir, jjm_jBtnAlterar, jjm_jBtnExcluir, jjm_jBtnPesquisar);
      ...
      try {
           ...
           jjm_jFmtDatadecadastro.setFormatterFactory(new DefaultFormatterFactory(mascaraDataNasc));
            ...
            Logger.getLogger(Eg_JDlgVendedor.class.getName()).log(Level.SEVERE, null, ex);
        }
...
timer.start();
    ...
    public EgVendedor viewBean() {
    EgVendedor jjmVendedor = new EgVendedor();
    jjmVendedor.setIdVendedor(Util.strToInt(jjm_jTxtVendedor.getText()));
    jjmVendedor.setNomeCompleto(jjm_jTxtNome.getText());
    jjmVendedor.setEmail(jjm_jTxtEmail.getText());
    jjmVendedor.setTelefone(jjm_jTxtTelefone.getText());
      SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                try {
                    Date dataNasc = formato.parse(jjm_jFmtDatadecadastro.getText());
                    jjmVendedor.setDataCadastro(dataNasc);
                } catch (ParseException ex) {
                    Logger.getLogger(Eg_JDlgVendedor.class.getName()).log(Level.SEVERE, null, ex);
                }
    jjmVendedor.setSalario(Util.strToDuble(jjm_jTxtSalario.getText()));
    jjmVendedor.setEndereco(jjm_jTxtEndereco.getText());
    return jjmVendedor;
}

public void beanView(EgVendedor jjmVendedor) {
    jjm_jTxtVendedor.setText(Util.intToStr(jjmVendedor.getIdVendedor()));
    jjm_jTxtNome.setText(jjmVendedor.getNomeCompleto());
    jjm_jTxtEmail.setText(jjmVendedor.getEmail());
    jjm_jTxtTelefone.setText(jjmVendedor.getTelefone());
     SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                String dataNasc = formato.format(jjmVendedor.getDataCadastro());
                jjm_jFmtDatadecadastro.setText(dataNasc);
    jjm_jTxtSalario.setText(Util.doubleToStr(jjmVendedor.getSalario()));
    jjm_jTxtEndereco.setText(jjmVendedor.getEndereco());
}
    ...
    private void jjm_jBtnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jjm_jBtnPesquisarActionPerformed
        ...
        */
        Eg_JDlgVendedorPesquisar jDlgVendedorPesquisar = new Eg_JDlgVendedorPesquisar(null, true);
 ...
 Util.habilitar(true, jjm_jTxtNome, jjm_jTxtEmail,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eg_JDlgVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Eg_JDlgVendedor dialog = new Eg_JDlgVendedor(new javax.swing.JFrame(), true);
