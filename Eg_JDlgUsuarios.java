 ...
 * @author 08111349114
 */
public class Eg_JDlgUsuarios extends javax.swing.JDialog {

    private UsuariosDAO usuariosDAO = new UsuariosDAO();

    /**
     * Creates new form Eg_JDlgUsuarios
     */
        boolean pesquisando = false;
        private MaskFormatter mascaraCpf, mascaraDataNasc;

    private boolean incluir; 
    public Eg_JDlgUsuarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    try {
          ...
          Logger.getLogger(Eg_JDlgUsuarios.class.getName()).log(Level.SEVERE, null, ex);        }
...
timer.start();
    ...
    public EgUsuarios viewBean() {
    EgUsuarios jjmUsuarios = new EgUsuarios();

    jjmUsuarios.setIdUsuario(Util.strToInt(jjm_jTxtCodigo.getText()));
    jjmUsuarios.setNomeCompleto(jjm_jTxtNome.getText());
    jjmUsuarios.setApelido(jjm_jTxtApelido.getText());
    jjmUsuarios.setCpf(jjm_jFmtCpf.getText());
    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                try {
                    Date dataNasc = formato.parse(jjm_jFmtDataDenascimento.getText());
                    jjmUsuarios.setDataNascimento(dataNasc);
                } catch (ParseException ex) {
                    Logger.getLogger(Eg_JDlgUsuarios.class.getName()).log(Level.SEVERE, null, ex);
                }
    jjmUsuarios.setSenha(jjm_PwdSenha.getText());
    jjmUsuarios.setNivelAcesso(jjm_jCboNivel.getSelectedIndex());

    if (jjm_jChbAtivo.isSelected()) {
        jjmUsuarios.setAtivo("S");
    } else {
        jjmUsuarios.setAtivo("N");
    }
...
public void beanView(EgUsuarios jjmUsuarios) {
    jjm_jTxtCodigo.setText(Util.intToStr(jjmUsuarios.getIdUsuario()));
    jjm_jTxtNome.setText(jjmUsuarios.getNomeCompleto());
    jjm_jTxtApelido.setText(jjmUsuarios.getApelido());
    jjm_jFmtCpf.setText(jjmUsuarios.getCpf());
    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                String dataNasc = formato.format(jjmUsuarios.getDataNascimento());
                jjm_jFmtDataDenascimento.setText(dataNasc);
    jjm_PwdSenha.setText(jjmUsuarios.getSenha());
    jjm_jCboNivel.setSelectedIndex(jjmUsuarios.getNivelAcesso());

    if ("S".equals(jjmUsuarios.getAtivo())) {
...
jjm_jTxtCodigo.grabFocus();
   ...
   if (Util.perguntar("Deseja Excluir?") == true) {
    ...
    private void jjm_jBtnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jjm_jBtnPesquisarActionPerformed
        ...
        UsuariosDAO usuariosDao = new UsuariosDAO();
        EgUsuarios usuarios = (EgUsuarios) usuariosDao.list(codigo);
        if (usuarios == null) {
        ...
        Eg_JDlgUsuariosPesquisar jDlgUsuariosPesquisar = new Eg_JDlgUsuariosPesquisar(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
           ...
           java.util.logging.Logger.getLogger(Eg_JDlgUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
           java.util.logging.Logger.getLogger(Eg_JDlgUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(Eg_JDlgUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              Eg_JDlgUsuarios dialog = new Eg_JDlgUsuarios(new javax.swing.JFrame(), true);
