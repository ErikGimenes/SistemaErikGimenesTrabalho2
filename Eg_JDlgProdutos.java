 ...
 * @author 08111349114
 */
public class Eg_JDlgProdutos extends javax.swing.JDialog {

    private ProdutosDAO produtosDAO = new ProdutosDAO();

    /**
     * Creates new form Eg_JDlgProdutos
     */ private boolean incluir; 
        boolean pesquisando = false;
            private MaskFormatter mascaraCpf, mascaraDataNasc;


    public Eg_JDlgProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Util.habilitar(false, jjm_jTxtProduto, jjm_jTxtNome, jjm_jTxtDescricao,
          ...
          try {
           ...
           Logger.getLogger(Eg_JDlgProdutos.class.getName()).log(Level.SEVERE, null, ex);
        }
...
public EgProdutos viewBean() {
    EgProdutos jjmProdutos = new EgProdutos();

    jjmProdutos.setIdProduto(Util.strToInt(jjm_jTxtProduto.getText()));
    jjmProdutos.setNome(jjm_jTxtNome.getText());
    jjmProdutos.setDescricao(jjm_jTxtDescricao.getText());
    jjmProdutos.setPreco(Util.strToDuble(jjm_jTxtPreco.getText()));
    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
 try {
                    Date dataNasc = formato.parse(jjm_jFmtDatadecadastro.getText());
                    jjmProdutos.setDataCadastro(dataNasc);
                } catch (ParseException ex) {
                    Logger.getLogger(Eg_JDlgProdutos.class.getName()).log(Level.SEVERE, null, ex);
                }
    jjmProdutos.setMarca(jjm_jTxtMarca.getText());
    jjmProdutos.setCategoria(jjm_jTxtCategoria.getText());

    return jjmProdutos;
}

public void beanView(EgProdutos jjmProdutos) {
    jjm_jTxtProduto.setText(Util.intToStr(jjmProdutos.getIdProduto()));
    jjm_jTxtNome.setText(jjmProdutos.getNome());
    jjm_jTxtDescricao.setText(jjmProdutos.getDescricao());
    jjm_jTxtPreco.setText(Util.doubleToStr(jjmProdutos.getPreco()));
    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                String dataNasc = formato.format(jjmProdutos.getDataCadastro());
                jjm_jFmtDatadecadastro.setText(dataNasc);
    jjm_jTxtMarca.setText(jjmProdutos.getMarca());
    jjm_jTxtCategoria.setText(jjmProdutos.getCategoria());
}
 ...
 ProdutosDAO produtosDAO = new ProdutosDAO();
    ...
    private void jjm_jBtnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jjm_jBtnPesquisarActionPerformed
        ...
        EgProdutos produto = (EgProdutos) produtoDAO.list(codigo);
        if (produto == null) {
       ...
       Eg_JDlgProdutoPesquisar jDlgProdutoPesquisar = new Eg_JDlgProdutoPesquisar(null, true);
 ...
 Util.habilitar(false, jjm_jTxtProduto, jjm_jTxtNome, jjm_jTxtDescricao,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eg_JDlgProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Eg_JDlgProdutos dialog = new Eg_JDlgProdutos(new javax.swing.JFrame(), true);
